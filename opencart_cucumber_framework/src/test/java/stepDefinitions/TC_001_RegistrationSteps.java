...
public class TC_001_RegistrationSteps {
	...
	public void user_enters_the_details_into_below_fields(DataTable dataTable) {
		...
		BaseClass.getLogger().info(".....enter the details for registration   ");
	...
	{
		BaseClass.getLogger().info(".....user select the privacy policy.. ");
	...
	{
		BaseClass.getLogger().info("-->Click on continue.. ");
	...
	public void user_account_should_get_created_successfully() {
		...
		BaseClass.getLogger().info("....user get success message.. ");
